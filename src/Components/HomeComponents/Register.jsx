  ...
  return (
    <>
      <div style={style} className=" flex flex-col items-center justify-center">
        ...
        <div className="text-white lg:text-7xl md:text-6xl sm:text-5xl text-4xl justify-center my-8 lg:my-5" style={{fontFamily: 'nasa'}}>
          2K23
        </div>
        <div className="text-white lg:text-6xl md:text-5xl sm:text-2xl text-xl my-5" style={{fontFamily: 'michroma'}}>
          "Feel The Pulse of Innovation"
        </div>
        <div className="text-white lg:text-4xl md:text-3xl sm:text=2xl text-xl my-3">
          <button className=" hover:bg-blue-700 text-yellow-400 font-bold py-2 px-4 rounded-lg backdrop-blur-3xl my-7 lg:my-5" style={{fontFamily: 'Syne'}}>
            REGISTER NOW
          </button>
        </div>
